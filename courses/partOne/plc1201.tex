...
\maketitle{Peace, Leadership and Conflict Transformation \Romannum{2}}{Business Management}{\DTMusedate{mydate}}

% ----------------------------------------------------- %
% COURSE INFO
\subsection*{Course Information}\label{course:plc1201}
\vspace{0ex}%
\noindent\parbox{0.5\textwidth}{%
    \noindent\begin{tabular}{@{}ll}
                 \textsf{Course:}          & 	Peace, Leadership and Conflict Transformation \Romannum{2}    \\
                 \textsf{Course Code:}         & 	PLC 1201    \\
...
\begin{outline}
    \1 Leadership
    \1 Leadership and Conflict Transformation Skills
    \1 Non-Violence
    \1 Classification of Leaders
    \1 Nexus Between Leadership and Conflict
    \1 Interplay: Leadership, Conflict and Development
\end{outline}
\vspace{2ex} \hrule\vspace{2ex}
...
\begin{itemize}
    ...
    \item CARTWRIGHT, J (2004) Political Leadership in Africa, London.
    \item Clocker, C. et al (1994) Multiparty Mediation & The Conflict Cycle.
    \item Deng , Z. (2002) Developmental Challenges in Africa. London, OUP.
    \item Mazrui, Ali ((1990) Cultural Forces in World Politics, Nairobi, James Currey Ltd.
    \item McDonald, J (1996) Multi-Track Diplomacy: A System Approach to Peace 3rd Edition, Kumarian Press.
    \item Sandole, D. J. D and Merwe van der Hugo. (1993). Conflict Resolution Theory and Practice: Integration and Application Manchester: Manchester University Press.
